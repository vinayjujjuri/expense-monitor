...
export default function YearlySavingsSummary() {
  ...
  const topCategories = categories.slice(0, 4);
    ...
    const totalDebitCreditComponent = () => {
        return (
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                ...
                <div
                    className={`rounded-2xl p-5 text-center ${savings >= 0 ? "bg-teal-50" : "bg-orange-50"
                        }`}
                >
                    <p className="text-sm font-medium text-gray-600">Net Savings</p>
                    <p
                        className={`mt-3 text-3xl font-semibold ${savings >= 0 ? "text-teal-900" : "text-orange-900"
                            }`}
                    >
